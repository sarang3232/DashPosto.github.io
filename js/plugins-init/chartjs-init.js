   ...
   var dlabSparkLine = function(){
	  ...
	  var barChart1 = function(){
		...
		if(jQuery('#barChart_1').length > 0 ){
			...
			barChart_1gradientStroke.addColorStop(0, "rgba(91, 207, 197, 1)");
			barChart_1gradientStroke.addColorStop(1, "rgba(91, 207, 197, 0.5)");

			const barChart_1gradientStroke2 = barChart_1.createLinearGradient(50, 100, 50, 50);
			barChart_1gradientStroke2.addColorStop(0, "rgba(112, 159, 186, 1)");
			barChart_1gradientStroke2.addColorStop(1, "rgba(112, 159, 186, 1)");
			
			barChart_1.height = 100;

			let barChartData = {
				defaultFontFamily: 'Poppins',
				labels: ['22-23pm', '23-24am', '24-1am', '1-2am', '2-3am', '3-4am','4-5am','5-6am'],
				datasets: [{
	  ...
	  var barChart2 = function(){
		...
		if(jQuery('#barChart_2').length > 0 ){
			...
			//generate gradient
			const barChart_2gradientStroke = barChart_2.createLinearGradient(50, 100, 50, 50);
			barChart_2gradientStroke.addColorStop(0, "rgba(91, 207, 197, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(91, 207, 197, 0.5)");

			const barChart_2gradientStroke2 = barChart_2.createLinearGradient(50, 100, 50, 50);
			barChart_2gradientStroke2.addColorStop(0, "rgba(112, 159, 186, 1)");
			barChart_2gradientStroke2.addColorStop(1, "rgba(112, 159, 186, 1)");
			
			barChart_2.height = 100;

			let barChartData = {
				defaultFontFamily: 'Poppins',
				labels: ['14-15pm', '15-16pm', '16-17pm', '17-18pm', '18-19pm', '19-20pm','20-21pm','21-22pm'],
				datasets: [{
					label: 'Tiempo perdido',
	  ...
	  var barChart5 = function(){
		  ...
		  if(jQuery('#barChart_5').length > 0 ){
			  ...
			  //generate gradient
			  const barChart_5gradientStroke = barChart_5.createLinearGradient(50, 100, 50, 50);
			  barChart_5gradientStroke.addColorStop(0, "rgba(91, 207, 197, 1)");
			  barChart_5gradientStroke.addColorStop(1, "rgba(91, 207, 197, 0.5)");
  
			  const barChart_5gradientStroke2 = barChart_5.createLinearGradient(50, 100, 50, 50);
			  barChart_5gradientStroke2.addColorStop(0, "rgba(112, 159, 186, 1)");
			  barChart_5gradientStroke2.addColorStop(1, "rgba(112, 159, 186, 1)");
			  
  
			  let barChartData = {
				  defaultFontFamily: 'Poppins',
				  labels: ['6-7am', '7-8am', '8-9am', '9-10am', '10-11am', '11-12pm','12-13pm','13-14pm'],
				  datasets: [{
					  label: 'Tiempo perdido',
					  backgroundColor: barChart_5gradientStroke,
					  hoverBackgroundColor: barChart_5gradientStroke, 
					  data:TiempoPerdido,
				  }, {
					  label: 'Tiempo acumulado',
					  backgroundColor: barChart_5gradientStroke2,
					  hoverBackgroundColor: barChart_5gradientStroke2, 
