(function($) {
 ...
 var dlabChartlist = function(){
  ...
  <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
	  <span>7-8am</span>
	  <span class="fs-16"><span class="text-black pe-2">9935%</span>
  </div>
  <div class="progress default-progress mt-4">
	...
	var chartBar3 = function(){
		...
		shape: "circle",
			...
			xaxis: {
			  ...
			  categories: ['14-15pm', '15-16pm', '16-17pm', '17-18pm', '18-19pm', '19-20pm','20-21pm','21-22pm'],
			  labels: {
			   style: {
				  colors: '#3e4954',
				  fontSize: '13px',
	...
	var chartBar4 = function(){
		...
		shape: "circle",
			...
			xaxis: {
			  ...
			  categories: ['22-23pm', '23-24am', '24-1am', '1-2am', '2-3am', '3-4am','4-5am','5-6am'],
			  labels: {
			   style: {
				  colors: '#3e4954',
				  fontSize: '13px',
			...
			var chartBar1 = new ApexCharts(document.querySelector("#chartBar4"), options);
			chartBar1.render();
	}
